...
// 图片加载失败时回退到本地占位图，避免库中脏数据或缺失文件导致裂图、卡片塌缩
...
<template>
  <div class="search-bar">
    <el-dropdown trigger="click" @command="onCityChange">
      <div class="city-btn">
        {{ city }} <el-icon><ArrowDown /></el-icon>
      </div>
      <template #dropdown>
        <el-dropdown-menu>
          <el-dropdown-item
  ...
  <div class="blog-list" @scroll="onScroll">
    <div class="blog-box" v-for="b in blogs" :key="b.id" @click="toBlogDetail(b)">
      <div class="blog-img">
        <img
